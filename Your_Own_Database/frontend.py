'''
Created on 04 May 2022,  11.43 PM
...
# ---------- LABLES ---------------!
l1 = Label(win, text='Date', bg = "pink", bd = 5, justify = RIGHT, padx = 10, pady = 10)
l1.grid(row=0,column=0)

l2 = Label(win, text='Earnings', bg = "pink", bd = 5, justify = RIGHT, padx = 10, pady = 10)
l2.grid(row=0,column=2)

l3 = Label(win, text='Exercise', bg = "pink", bd = 5, justify = RIGHT, padx = 10, pady = 10)
l3.grid(row=3,column=0)

l4 = Label(win, text='Study', bg = "pink", bd = 5, justify = RIGHT, padx = 10, pady = 10)
l4.grid(row=3,column=2)

l5 = Label(win, text='Diet', bg = "pink", bd = 5, justify = RIGHT, padx = 10, pady = 10)
l5.grid(row=4,column=0)

l6 = Label(win, text='Python', bg = "pink", bd = 5, justify = RIGHT, padx = 10, pady = 10)
...
# -------------- LIST BOX OR TEXTAREA ------------------!
list = Listbox(win,height=20,width=50)
list.grid(row=5,column=0,rowspan=15,columnspan=5)

# -------------- SCROLL BAR ------------------!
sb = Scrollbar(win)
sb.grid(row=5,column=3,rowspan=9)

list.bind('<<ListboxSelect>>',get_selected_row)

# -------------- BUTTONS ------------------!
b1 = Button(win,text='ADD',width=12,pady=5, font=('Poppins bold', 10), command = add_command)
b1.grid(row=5,column=5)

b2 = Button(win,text='Search',width=12,pady=5, font=('Poppins bold', 10), command = search_command)
b2.grid(row=6,column=5)

b3 = Button(win,text='Delete date',width=12,pady=5, font=('Poppins bold', 10), command = delete_command)
b3.grid(row=7,column=5)

b4 = Button(win,text='View all',width=12,pady=5, font=('Poppins bold', 10), command = view_command)
b4.grid(row=8,column=5)

b5 = Button(win,text='Close',width=12,pady=5, font=('Poppins bold', 10), command = win.destroy)
