...
label1 = Label(root, text = 'Enter Words : ',font= ('times', 15, 'italic bold'), bg= 'red'  )
label1.place(x= 10, y =40)

label2 = Label(root, text = 'Translated',font= ('times', 15, 'italic bold'), bg= 'red'  )
label2.place(x= 10, y =100)

label3 = Label(root, text = '',font= ('times', 15, 'italic bold'), bg= 'light pink'  )
label3.place(x= 20, y =250)

################################################ Buttons

btn1 = Button(root, text= 'Click !', bd= 10, bg= 'yellow', activebackground= 'blue', width= 10,font= ('times', 15, 'italic bold'), command= tt )
btn1.place(x = 70, y= 170)

btn2 = Button(root, text= 'Exit', bd= 10, bg= 'yellow', activebackground= 'blue', width= 10,font= ('times', 15, 'italic bold'), command= main_exit )
btn2.place(x = 280, y= 170)

root.bind('<Return>', tt)
#################################################### Binding

entry1.bind('<Enter>', on_entryentry1)
entry1.bind('<Leave>', on_leaveentry1)

entry2.bind('<Enter>', on_entryentry2)
